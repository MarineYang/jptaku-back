...
type Sentence struct {
	...
	Tags      []string       `gorm:"type:text[];serializer:json" json:"tags"` // 애니, 게임, 성지순례, 이벤트 등
...
type SentenceDetail struct {
	...
	Grammar    []string `gorm:"type:text[];serializer:json" json:"grammar"`  // 핵심 문법
	Examples   []string `gorm:"type:text[];serializer:json" json:"examples"` // 예문
}
